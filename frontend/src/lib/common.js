...
// export async function addProjet(FormData) {
//   console.log("Data received:", FormData); 
  ...
  // };
  // const bodyFormData = new FormData();
// FormData.append('userId', JSON.stringify(projet));
  
//   if (data.file && data.file.length > 0) {
//   bodyFormData.append('image', data.file[0]);
//   console.log("Image file:", data.file[0]); // Affiche les détails du premier fichier
// } else {
//   console.log("No image file attached"); // Aucun fichier joint
// }
